...
export default function ReservationSection() {
  ...
  return (
    <section id="reservation" className="py-20 md:py-24 bg-navy">
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-2xl space-y-5">
            <div>
              <label className="block text-navy font-medium text-sm mb-1">이름 <span className="text-red-500">*</span></label>
              <input
                type="text"
                required
                value={form.name}
            ...
            <div>
              <label className="block text-navy font-medium text-sm mb-1">연락처 <span className="text-red-500">*</span></label>
              <input
                type="tel"
                required
                value={form.phone}
            ...
            <div>
              <label className="block text-navy font-medium text-sm mb-1">관심 평형</label>
              <select
                value={form.area}
                onChange={(e) => setForm({ ...form, area: e.target.value })}
                className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-navy bg-white"
              >
            ...
            <button
              type="submit"
              className="w-full bg-navy text-white font-bold py-4 rounded-lg hover:opacity-90 transition-opacity text-base"
            >
              예약 신청하기
            </button>
          </form>
        ...
        <div className="mt-10 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-gold text-white font-black text-2xl px-10 py-5 rounded-2xl shadow-2xl hover:opacity-90 transition-opacity"
          >
            📞 {reservation.phone}
