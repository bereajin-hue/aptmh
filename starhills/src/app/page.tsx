...
export default function Home() {
  return (
    <>
      ...
      <footer className="bg-navy text-gray-400 text-center text-xs py-8 px-4">
        <p>© 2026 용인양지 서희스타힐스 하이뷰. All rights reserved.</p>
        <p className="mt-1">경기도 용인시 처인구 양지면 816-7번지 일대 | 대표전화: 1599-1877</p>
        <div className="mt-4 pt-4 border-t border-gray-700 text-left max-w-4xl mx-auto space-y-1 leading-relaxed">
