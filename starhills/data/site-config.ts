export const siteConfig = {
  meta: {
    ...
    description:
      "반도체클러스터 10분대 · 1,265세대 ☎ 1599-1877",
    keywords:
  ...
  business: {
    overview: [
      { label: "사  업  명", value: "용인양지 서희스타힐스 하이뷰" },
      { label: "연  면  적", value: "179,584.4000㎡" },
      { label: "대지위치", value: "경기도 용인시 처인구 양지면 양지리 산105-8번지 일원" },
      { label: "건  폐  율", value: "22.20% (법정 30% 이하)" },
      { label: "대지면적", value: "50,616.0000㎡" },
      { label: "용  적  율", value: "238.73% (법정 240.00% 이하)" },
      { label: "건축면적", value: "11,235.4411㎡" },
      { label: "건물규모", value: "지하 3층 ~ 지상 29층 총 1,265세대 중 일반분양 547세대" },
      { label: "주차계획", value: "아파트 1,673대 / 근린생활시설 11대" },
    ],
    sellingPoints: [
